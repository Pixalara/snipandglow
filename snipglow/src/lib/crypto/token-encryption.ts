...
// Pure, dependency-free encryption for dedicated WhatsApp access tokens at rest.
// Ported verbatim from functions/src/whatsapp/crypto.util.ts so the storage
// format (base64(IV ‖ ciphertext ‖ authTag)) is identical across codebases.
// =============================================================================
 ...
 * @throws Error if decryption fails (wrong key, corrupted data, tampered, etc.)
 */
