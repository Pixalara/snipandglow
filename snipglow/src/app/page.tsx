          ...
          <div className="space-y-8 reveal-left">
            ...
            <div className="grid grid-cols-2 gap-2 py-2">
              {[
                ...
                <div key={label} className="flex items-center gap-2 bg-white rounded-xl px-3 py-2.5 border border-slate-100 shadow-sm min-w-0">
                  {icon === 'whatsapp' ? (
                  ...
                  <div className="min-w-0">
                    <p className="text-xs font-bold text-slate-900 leading-tight truncate">{label}</p>
