      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="rounded-xl border border-slate-800 bg-slate-900 p-6 space-y-4">
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 h-11 rounded-lg border border-slate-700 bg-slate-800 text-white text-sm font-medium hover:bg-slate-700 transition-colors disabled:opacity-50"
          >
